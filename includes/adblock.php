...
function DisplayAdBlockConfig()
{
    ...
    if (!RASPI_MONITOR_ENABLED) {
        if (isset($_POST['saveadblocksettings'])) {
            ...
            $GLOBALS['gwconn']->run_exec_gateway('sudo /bin/systemctl restart dnsmasq.service', $dnsmasq, $return);
            if ($return == 0) {
    ...
    $GLOBALS['gwconn']->run_exec_gateway('cat '. RASPI_ADBLOCK_CONFIG, $return);
